...
<style>
    ...
    .header h2 { font-size: 13px; margin: 3px 0; font-weight: bold; }
    .header h3 { font-size: 12px; margin: 2px 0; font-weight: normal; }
    .divider { border-top: 2px solid #000; margin: 10px 0 15px; }
    .report-title { text-align: center; font-weight: bold; font-size: 13px; text-transform: uppercase; }
    .report-subtitle { text-align: center; font-size: 11px; margin-bottom: 15px; }
    table { width: 100%; border-collapse: collapse; font-size: 10px; }
    th, td { border: 1px solid #000; padding: 4px; vertical-align: top; }
    th { text-align: center; font-weight: bold; }
    .text-center { text-align: center; }
    .footer { margin-top: 25px; font-size: 11px; }
    .signature { margin-top: 35px; width: 250px; }
...
<!-- ===== TITLE ===== -->
<div class="report-title">Solo Parent Applications Report</div>
<div class="report-subtitle">
    As of {{ now()->format('F d, Y') }}<br>
    All Barangays – City of General Trias, Cavite
</div>
...
@empty
<tr>
    <td colspan="24" class="text-center">No records available.</td>
</tr>
@endforelse
</tbody>
</table>
...
<div class="footer">
    <div class="signature">
        <div class="signature-name">Prepared By:</div><br><br>
